...
Strategie : demo_strategy
Generee le 2026-03-23 22:22
Assets : AAPL, GC=F, ^NDX, ^GSPC, MSFT, CL=F
"""
# __builder__: {"name": "demo_strategy", "desc": "demo_strategy", "exec_mode": "netting", "baskets": [{"id": "basket_1", "assets": ["AAPL", "MSFT", "^NDX", "^GSPC"], "weights": {"AAPL": 100.0, "MSFT": 50.0, "^NDX": 33.3, "^GSPC": 25.0}, "basket_size": 80.0, "basket_sl": 2.0, "basket_tp": 5.0, "use_custom_size": true, "use_sl": false, "use_tp": false, "entry_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "SMA", "left_period": 5, "left_series": "ADVDEC.NY", "op": ">", "right_type": "series_indicator", "right_name": "SMA", "right_period": 20, "right_series": "ADVDEC.NY", "right_value": 0.0, "lookback": 0, "persistence": 3, "human": "SMA(5) on ADVDEC.NY  >  SMA(20) on ADVDEC.NY  [≥3 consecutive bars]"}], "exit_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "^NDX", "op": "<", "right_type": "series_indicator", "right_name": "EMA", "right_period": 20, "right_series": "^NDX", "right_value": 0.0, "lookback": 0, "persistence": 3, "human": "RAW(1) on ^NDX  <  EMA(20) on ^NDX  [≥3 consecutive bars]"}], "short_entry_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "VIX3M_VIX", "op": "<", "right_type": "series_indicator", "right_name": "EMA", "right_period": 20, "right_series": "VIX3M_VIX", "right_value": 0.0, "lookback": 0, "persistence": 5, "human": "RAW(1) on VIX3M_VIX  <  EMA(20) on VIX3M_VIX  [≥5 consecutive bars]"}, {"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "VIX3M_VIX", "op": "<", "right_type": "value", "right_name": "", "right_period": 0, "right_series": "", "right_value": 1.0, "lookback": 0, "persistence": 3, "human": "RAW(1) on VIX3M_VIX  <  1.0  [≥3 consecutive bars]"}], "cover_exit_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "VIX3M_VIX", "op": "<", "right_type": "series_indicator", "right_name": "BOLLINGER_LOWER", "right_period": 20, "right_series": "VIX3M_VIX", "right_value": 0.0, "lookback": 0, "persistence": 0, "human": "RAW(1) on VIX3M_VIX  <  BOLLINGER_LOWER(20) on VIX3M_VIX"}, {"logic": "OR", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "^VIX", "op": "crosses_above", "right_type": "series_indicator", "right_name": "BOLLINGER_UPPER", "right_period": 20, "right_series": "^VIX", "right_value": 0.0, "lookback": 0, "persistence": 0, "human": "RAW(1) on ^VIX  crosses_above  BOLLINGER_UPPER(20) on ^VIX"}, {"logic": "OR", "left_type": "series_indicator", "left_name": "ROC", "left_period": 1, "left_series": "^GSPC", "op": ">=", "right_type": "value", "right_name": "", "right_period": 0, "right_series": "", "right_value": 2.0, "lookback": 0, "persistence": 0, "human": "^GSPC moves up by at least 2.00% in 1 bar"}]}, {"id": "basket_2", "assets": ["GC=F", "CL=F"], "weights": {"GC=F": 100.0, "CL=F": 50.0}, "basket_size": 60.0, "basket_sl": 2.0, "basket_tp": 5.0, "use_custom_size": true, "use_sl": false, "use_tp": false, "entry_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "CPI_YOY_PRELIM", "op": ">", "right_type": "series_indicator", "right_name": "SMA", "right_period": 4, "right_series": "CPI_YOY_PRELIM", "right_value": 0.0, "lookback": 0, "persistence": 0, "human": "RAW(1) on CPI_YOY_PRELIM  >  SMA(4) on CPI_YOY_PRELIM"}], "exit_conds": [{"logic": "AND", "left_type": "series_indicator", "left_name": "RAW", "left_period": 1, "left_series": "CPI_YOY_PRELIM", "op": "<", "right_type": "series_indicator", "right_name": "SMA", "right_period": 4, "right_series": "CPI_YOY_PRELIM", "right_value": 0.0, "lookback": 0, "persistence": 0, "human": "RAW(1) on CPI_YOY_PRELIM  <  SMA(4) on CPI_YOY_PRELIM"}], "short_entry_conds": [], "cover_exit_conds": []}]}
...
class DemoStrategy(BaseStrategy):
    ...
    def on_bar(self, symbol: str, bar: pd.Series) -> None:
        # ── Shared indicators ──────────────────────────────────────────────
        _advdec_ny_bars = self._data.get_latest_n_bars("ADVDEC.NY", 22)
        if _advdec_ny_bars is None or len(_advdec_ny_bars) < 22:
            return
        _sma_5_advdec_ny = compute_indicator("SMA", _advdec_ny_bars, 5)
        _sma_5_advdec_ny_prev = compute_indicator("SMA", _advdec_ny_bars.iloc[:-1], 5)
        _sma_20_advdec_ny = compute_indicator("SMA", _advdec_ny_bars, 20)
        _sma_20_advdec_ny_prev = compute_indicator("SMA", _advdec_ny_bars.iloc[:-1], 20)
        _ndx_bars = self._data.get_latest_n_bars("^NDX", 22)
        if _ndx_bars is None or len(_ndx_bars) < 22:
            return
        _raw_1_ndx = compute_indicator("RAW", _ndx_bars, 1)
        _raw_1_ndx_prev = compute_indicator("RAW", _ndx_bars.iloc[:-1], 1)
        _ema_20_ndx = compute_indicator("EMA", _ndx_bars, 20)
        _ema_20_ndx_prev = compute_indicator("EMA", _ndx_bars.iloc[:-1], 20)
        _vix3m_vix_bars = self._data.get_latest_n_bars("VIX3M_VIX", 22)
        if _vix3m_vix_bars is None or len(_vix3m_vix_bars) < 22:
            return
        _raw_1_vix3m_vix = compute_indicator("RAW", _vix3m_vix_bars, 1)
        _raw_1_vix3m_vix_prev = compute_indicator("RAW", _vix3m_vix_bars.iloc[:-1], 1)
        _ema_20_vix3m_vix = compute_indicator("EMA", _vix3m_vix_bars, 20)
        _ema_20_vix3m_vix_prev = compute_indicator("EMA", _vix3m_vix_bars.iloc[:-1], 20)
        _bollinger_lower_20_vix3m_vix = compute_indicator("BOLLINGER_LOWER", _vix3m_vix_bars, 20)
        _bollinger_lower_20_vix3m_vix_prev = compute_indicator("BOLLINGER_LOWER", _vix3m_vix_bars.iloc[:-1], 20)
        _vix_bars = self._data.get_latest_n_bars("^VIX", 22)
        if _vix_bars is None or len(_vix_bars) < 22:
            return
        _raw_1_vix = compute_indicator("RAW", _vix_bars, 1)
        _raw_1_vix_prev = compute_indicator("RAW", _vix_bars.iloc[:-1], 1)
        _bollinger_upper_20_vix = compute_indicator("BOLLINGER_UPPER", _vix_bars, 20)
        _bollinger_upper_20_vix_prev = compute_indicator("BOLLINGER_UPPER", _vix_bars.iloc[:-1], 20)
        _spx_bars = self._data.get_latest_n_bars("^GSPC", 3)
        if _spx_bars is None or len(_spx_bars) < 3:
            return
        _roc_1_spx = compute_indicator("ROC", _spx_bars, 1)
        _roc_1_spx_prev = compute_indicator("ROC", _spx_bars.iloc[:-1], 1)
        _cpi_yoy_prelim_bars = self._data.get_latest_n_bars("CPI_YOY_PRELIM", 6)
        if _cpi_yoy_prelim_bars is None or len(_cpi_yoy_prelim_bars) < 6:
            return
        _raw_1_cpi_yoy_prelim = compute_indicator("RAW", _cpi_yoy_prelim_bars, 1)
        _raw_1_cpi_yoy_prelim_prev = compute_indicator("RAW", _cpi_yoy_prelim_bars.iloc[:-1], 1)
        _sma_4_cpi_yoy_prelim = compute_indicator("SMA", _cpi_yoy_prelim_bars, 4)
        _sma_4_cpi_yoy_prelim_prev = compute_indicator("SMA", _cpi_yoy_prelim_bars.iloc[:-1], 4)
        ...
        if symbol in self._B1_ASSETS:
            ...
            _snapshot = {
                ...
                "RAW_1_^VIX": round(_raw_1_vix, 4),
                "BOLLINGER_UPPER_20_^VIX": round(_bollinger_upper_20_vix, 4),
                "ROC_1_^GSPC": round(_roc_1_spx, 4),
            ...
            # ─── Short entry ───────────────────────────────────────────
            # RAW(1) [sur VIX3M_VIX]  <  EMA(20) [sur VIX3M_VIX]  [for 5 consecutive bars]
            _raw_0 = (_raw_1_vix3m_vix < _ema_20_vix3m_vix)
            if not hasattr(self, '_persist_b1_sh_0'):
                self._persist_b1_sh_0 = {}
            if _raw_0:
                self._persist_b1_sh_0[symbol] = self._persist_b1_sh_0.get(symbol, 0) + 1
            else:
                self._persist_b1_sh_0[symbol] = 0
            _eff_0 = self._persist_b1_sh_0.get(symbol, 0) >= 5
            # RAW(1) [sur VIX3M_VIX]  <  1.0  [for 3 consecutive bars]
            _raw_1 = (_raw_1_vix3m_vix < 1.0)
            if not hasattr(self, '_persist_b1_sh_1'):
                self._persist_b1_sh_1 = {}
            if _raw_1:
                self._persist_b1_sh_1[symbol] = self._persist_b1_sh_1.get(symbol, 0) + 1
            else:
                self._persist_b1_sh_1[symbol] = 0
            _eff_1 = self._persist_b1_sh_1.get(symbol, 0) >= 3
            _short_entry = (
                (_eff_0)
                and (_eff_1)
            )
            ...
            _cover = (
                ...
                or (_raw_1_vix >= _bollinger_upper_20_vix and _raw_1_vix_prev < _bollinger_upper_20_vix_prev)
                or (_roc_1_spx >= 2.0)
            )
            ...
            _prio_s      = self._prio_b1.get((symbol, 's'))
            _short_rose  = _short_entry and not self._prev_b1.get((symbol, 'sh'), False)
            _cover_rose  = _cover       and not self._prev_b1.get((symbol, 'cv'), False)
            ...
            if _short_rose and _prio_s is None:
                ...
                _prio_s = 'cv'
            self._prio_b1[(symbol, 's')] = _prio_s
            self._prev_b1[(symbol, 'sh')] = bool(_short_entry)
            self._prev_b1[(symbol, 'cv')] = bool(_cover)

            if _prio_s == 'sh':
                self._pd_b1[symbol] = "SHORT"
                ...
                self._pd_b1[symbol] = None
                self.signal(symbol, "COVER", _snapshot, basket_id="basket_1")
